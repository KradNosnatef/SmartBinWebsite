<template>
	<div>
		<baidu-map class="bm-view" ak="uK1MNayhkgUDF5QPuvU6fsQGuoxKEN8u" center="新加坡" :zoom="12" :double-click-zoom="false">
			<bm-point-collection :points="points" shape="BMAP_POINT_SHAPE_STAR" color="red" @click="onPointClick" @mouseover="onPointMouseOver"></bm-point-collection>
